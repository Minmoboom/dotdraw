...
分类       Skill名               用途
──────────────────────────────────────────────────────────────────────────
通用       image-delivery        默认生图技巧 — 提示词写法、多图融合、避坑
品牌       brand-identity        Logo / 品牌标识 / 视觉识别 / 品牌套件
品牌       brand-campaign        品牌营销全案 — 棚拍→海报→概念→广告→包装
电商       ecommerce-product     电商产品图 — 主图/卖点图/场景图
电商       amazon-product        亚马逊产品图 — 主图+副图+A+ 页面
电商       ugc-style             真实素人风格 UGC/种草照片
社交       instagram-post        Instagram — Feed/Story/Reel/轮播图
社交       rednote-cover         小红书封面 — 3:4 竖版，10 种类型，8 种布局
社交       youtube-thumbnail     YouTube 缩略图 — 16:9，8 种类型
社交       ad-creative           多平台广告 — IG/FB/TikTok/LinkedIn 等全尺寸
时尚       fashion-outfit        穿搭造型 — 5 种风格方向
视频       video-creation        短视频创作 — 提示词、时长、运镜、音效
视频       drone-camera          无人机运镜 — 7 变量镜头模板
演示       slide-deck            幻灯片/PPT 设计 — 配色/字体/版式
